  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-grow text-center">
        ...
        <p className="text-md md:text-lg font-medium text-blue-500 mb-2">
          ₹ {book.price}
        </p>
        <div className="mt-auto">
          <Link to={`/book/${book._id}`} className="block">
            <ButtonPrimary className="w-full py-2 text-md hover:bg-blue-700 focus:ring-2 focus:ring-blue-500">
              View Details
            </ButtonPrimary>
          </Link>
        </div>
